...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        slideModels.add(new SlideModel(R.drawable.banner1, "Giam Gia 1", ScaleTypes.CENTER_CROP));
        slideModels.add(new SlideModel(R.drawable.banner2, "Giam Gia 2", ScaleTypes.CENTER_CROP));
        slideModels.add(new SlideModel(R.drawable.banner3, "Giam Gia 3", ScaleTypes.CENTER_CROP));
